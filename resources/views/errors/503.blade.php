...
<head>
    <meta charset="utf-8">
    <title>Bakım Modu | ITCRAFT CMS</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background:
                radial-gradient(circle at top left, rgba(176, 137, 104, .15), transparent 35%),
...
<body class="theme-enabled">
    <main class="error-wrap theme-scope">
        ...
        <p>
            Web sitemizde kısa süreli bir bakım çalışması yürütülüyor.
            Lütfen birkaç dakika sonra tekrar ziyaret edin.
        </p>
