...
<head>
    <meta charset="utf-8">
    <title>Sayfa Bulunamadı | ITCRAFT CMS</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background:
                radial-gradient(circle at top left, rgba(176, 137, 104, .16), transparent 35%),
...
<body class="theme-enabled">
    <main class="error-wrap theme-scope">
        ...
        <p>
            ...
            Ana sayfaya dönebilir ya da iletişim sayfasından bizimle bağlantıya geçebilirsiniz.
        </p>
